...
<footer id="footer" class="footer">
            ...
            <div class="row gy-4">
                <div class="col-lg-5 col-md-12 footer-info">
                    <a href="index.html" class="logo d-flex align-items-center">
                        <img src="<?= base_url('assets/img/') . $web['logo']; ?>" alt="">
    ...
    <div class="container">
        <div class="copyright">
            &copy; Copyright <strong><span><?= strtoupper($web['nama']); ?></span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            ...
            This Page Designed by <a href="https://bootstrapmade.com/">BootstrapMade</a> And Webapp Developed by <a href="#"><?= $web['author']; ?></a>
        </div>
    </div>
</footer><!-- End Footer -->
